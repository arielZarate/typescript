...
const NinjaDetail = () => {
  ...
  return (
    <div className="my-20 py-10 px-2 mx-2 text-white hover:cursor-pointer">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-4 border-slate-500 rounded-md">
        <div className="md:border-r-4 border-slate-200">
          <h1 className="font-bold text-3xl text-center py-3 text-slate-300 rounded-sm hover:text-green-500 duration-300">
            {ninja.nombre}
          </h1>
        ...
        <div className="flex flex-col py-5 gap-2 px-4">
          ...
          <ul className="border-2 border-slate-400 w-52 rounded-md p-2">
